<p align="center">
  <img src="docs/assets/sage_logo.svg" alt="智账" width="96" height="96" />
</p>
...
**智账（Sage）** 是一款基于 Flutter 的**本地优先**个人记账应用。支持多账本、预算、统计图表、账单筛选与消费分析，数据仅保存在你的设备上，无需注册账号、无需联网即可使用。
...
- **数据备份**：Excel / PDF 导入导出；理财记录独立工作表导出（含利率、到期日）；分类以「父·子」标签导出并可还原；支持全局自定义导入分类规则
...
- 更新应用图标：`flutter test test/tool/generate_app_icon_test.dart && dart run flutter_launcher_icons`。
