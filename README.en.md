...
- **Backup** Excel/PDF import & export; wealth records on a separate sheet (rate, maturity); parent·child category labels round-trip on import; global custom import category rules
...
Current version: `1.1.2+4` (see `pubspec.yaml`).
